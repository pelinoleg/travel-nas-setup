...
EOF
    ...
    # --enable-wayland-ime: чтобы тач-клавиатура (squeekboard) всплывала на полях ввода
    KIOSK="$CHROME --kiosk --app=http://localhost:$WD_PORT --ozone-platform=wayland --enable-wayland-ime --noerrdialogs --disable-infobars --password-store=basic --disable-features=Translate,TranslateUI --lang=ru-RU --check-for-update-interval=31536000"
